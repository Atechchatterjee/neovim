return {
  ...
  },
  {
    ...
    init = function()
      ...
      lackluster.setup {
        disable_plugin = {
          lsp_config = true, -- Disables lackluster's styling of LSP diagnostics/highlights
        },
        tweak_highlight = {
          ['@lsp.token.variable'] = { bg = 'none' },
          ['@variable'] = { bg = 'none' },
          -- If it's a specific "under-cursor" group, you might need to set it to none
          ['CursorWord'] = { bg = 'none' },
        },
        -- Remove the highlighting from the current word
